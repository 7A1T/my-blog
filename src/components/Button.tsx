...
export default function Button({
  ...
  const baseStyles =
    "inline-flex items-center justify-center font-medium transition-colors duration-200 gap-2";

  const variantStyles = {
    primary: "bg-[var(--color-primary)] hover:opacity-90",
    secondary: "bg-[var(--color-secondary)] hover:opacity-90",
    outline:
      "border border-[var(--color-primary)] text-[var(--color-primary)] data-hover:bg-gray-700",
  };
